...
export function ConsultationDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => (!v ? resetAndClose() : undefined)}>
      <DialogContent className="max-h-[92vh] max-w-lg overflow-y-auto rounded-2xl border-navy-900/10 bg-white p-0 shadow-lift sm:max-w-lg sm:rounded-2xl">
        {status === "success" ? (
          <div className="flex flex-col items-center px-8 py-14 text-center">
            <span className="grid h-16 w-16 place-items-center rounded-full bg-electric-500/10 text-electric-600">
            ...
            <button
              ...
              className="mt-8 inline-flex h-11 items-center rounded-full bg-navy-900 px-8 text-sm font-semibold text-white transition hover:bg-royal-600"
            >
              Done
            </button>
          </div>
          ...
          <div className="p-7 sm:p-8">
            <DialogHeader className="text-left">
              ...
              <DialogTitle className="mt-2 font-display text-2xl font-bold tracking-tight text-ink">
            ...
            <form onSubmit={handleSubmit} className="mt-7 grid gap-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    className="h-11 rounded-xl border-navy-900/12 bg-mist/60 focus-visible:ring-electric-500"
                  />
                </div>
                <div className="grid gap-1.5">
              ...
              <div className="grid gap-1.5">
                ...
                <Select name="interest" defaultValue={interest ?? "Not sure yet"}>
                  <SelectTrigger className="h-11 w-full rounded-xl border-navy-900/12 bg-mist/60 focus-visible:ring-electric-500">
              ...
              <div className="grid gap-1.5">
                ...
                <Textarea
                  ...
                  className="resize-none rounded-xl border-navy-900/12 bg-mist/60 focus-visible:ring-electric-500"
                />
              </div>
